          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6 offset-md-3">
                <ul className="sociel">
                  <li className="text-light"> <a href="#" ><i className="fa fa-facebook"></i></a></li>
                  <li className="text-light"> <a href="#"><i className="fa fa-twitter"></i></a></li>
                  <li className="text-light"> <a href="#"><i className="fa fa-instagram"></i></a></li>
                  <li className="text-light"> <a href="#"><i className="fa fa-linkedin"></i></a></li>
                </ul>
              </div>
            </div>
            <div className="row">
