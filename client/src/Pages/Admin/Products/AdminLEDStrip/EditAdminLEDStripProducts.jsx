...
const EditAdminLEDStripProducts = () => {
  ...
  const getSingleLEDStripProduct = async (id) => {
    const response = await fetch(`${server}/api/v1/adminproducts/getsingaledstripproducts/${id}`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${server}/api/v1/adminproducts/updateledstripproducts/${id}`, {
        method: "PUT",
        headers: {
          "Authorization": authorizationToken,
  ...
  return (
    <>
      <div className="container my-5">
        <h2 className="fw-bold mb-3">Edit LED Strip Product</h2>
