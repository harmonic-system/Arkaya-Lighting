...
const AdminChandeliers = () => {
    ...
    const deleteProduct = async (id) => {
        try {
            const response = await fetch(`${server}/api/v1/lightingfixture/admindecorative/deletechandeliers/${id}`, {
                method: "DELETE",
                headers: {
                    'Authorization': token,
                }
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Admin Chandeliers Products</h2>
                <div className="w-100 d-flex justify-content-end my-5">
                    <Link className="btn btn-warning" to="/admin/addchandeliers" >Add Product</Link>
                </div>
                    ...
                    <tbody>
                        {
                            chandeliers.map((product) => {
                                ...
                                return <tr key={product._id}>
                                    ...
                                    <td><Link to={`/admin/editchandeliers/${product._id}`} className="bg-transparent" ><FaEdit className="bg-transparent" /></Link></td>
...
export default AdminChandeliers;