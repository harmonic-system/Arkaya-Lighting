...
const AddAdminLedMatrix = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/lightingfixture/adminledpixels/addledmatrix`, {
                method: "POST",
                headers: {
                    "Authorization": token,
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Add Led Matrix Product</h2>
...
export default AddAdminLedMatrix;