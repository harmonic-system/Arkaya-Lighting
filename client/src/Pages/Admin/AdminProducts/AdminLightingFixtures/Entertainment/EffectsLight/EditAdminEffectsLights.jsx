...
const EditAdminEffectsLights = () => {
  ...
  const getSingleProduct = async (id) => {
    const response = await fetch(`${server}/api/v1/lightingfixture/adminentertainment/getsingaleffectlight/${id}`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${server}/api/v1/lightingfixture/adminentertainment/updateeffectlight/${id}`, {
        method: "PUT",
        headers: {
          "Authorization": authorizationToken,
  ...
  return (
    <>
      <div className="container my-5">
        <h2 className="fw-bold mb-3">Edit Effects Light Product</h2>
...
export default EditAdminEffectsLights;