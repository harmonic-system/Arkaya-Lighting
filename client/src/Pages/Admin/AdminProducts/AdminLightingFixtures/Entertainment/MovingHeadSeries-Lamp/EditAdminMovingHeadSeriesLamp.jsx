...
const EditAdminMovingHeadSeriesLamp = () => {
    ...
    const getSingleProduct = async (id) => {
        const response = await fetch(`${server}/api/v1/lightingfixture/adminentertainment/getsingalmovingheadlamp/${id}`, {
            method: "GET",
            headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/lightingfixture/adminentertainment/updatemovingheadlamp/${id}`, {
                method: "PUT",
                headers: {
                    "Authorization": authorizationToken,
            ...
            if (response.ok) {
                ...
                setSpinner(false)
                navigate("/admin/movingheadserieslamp")
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Edit Moving Head Series Lamp Product</h2>
...
export default EditAdminMovingHeadSeriesLamp;