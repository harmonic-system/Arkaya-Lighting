...
const AddAdminMovingHeadSeriesLamp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/lightingfixture/adminentertainment/addmovingheadlamp`, {
                method: "POST",
                headers: {
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Add Moving Head Series Lamp Product</h2>
...
export default AddAdminMovingHeadSeriesLamp;