...
const EditAdminMovingHeadSeriesLed = () => {
    ...
    const getSingleProduct = async (id) => {
        const response = await fetch(`${server}/api/v1/lightingfixture/adminentertainment/getsingalmovingheadled/${id}`, {
            method: "GET",
            headers: {
                "Authorization": token
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/lightingfixture/adminentertainment/updatemovingheadled/${id}`, {
                method: "PUT",
                headers: {
                    "Authorization": token,
            ...
            if (response.ok) {
                ...
                setSpinner(false)
                navigate("/admin/movingheadseriesled")
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Edit Moving Head Series Led Product</h2>
...
export default EditAdminMovingHeadSeriesLed;