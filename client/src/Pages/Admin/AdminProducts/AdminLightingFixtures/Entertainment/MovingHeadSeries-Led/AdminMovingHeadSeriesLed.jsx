    ...
    const deleteProduct = async (id) => {
        try {
            ...
            if (response.ok) {
                ...
                getAllMovingHeadSeriesLedProducts()
            }
        } catch (error) {
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Admin Moving Head Series Led Products</h2>
                <div className="w-100 d-flex justify-content-end my-5">
                    <Link className="btn btn-warning" to="/admin/addmovingheadseriesled" >Add Product</Link>
                </div>
                    ...
                    <tbody>
                        {
                            movingHeadSeriesLed.map((product) => {
                                ...
                                return <tr key={product._id}>
                                    ...
                                    <td><Link to={`/admin/editmovingheadseriesled/${product._id}`} className="bg-transparent" ><FaEdit className="bg-transparent" /></Link></td>
...
export default AdminMovingHeadSeriesLed;