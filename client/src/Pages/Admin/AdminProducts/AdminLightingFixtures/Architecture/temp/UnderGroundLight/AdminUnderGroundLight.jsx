    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Admin Under Ground Products</h2>
                <div className="w-100 d-flex justify-content-end my-5">
                    <Link className="btn btn-warning" to="/admin/addundergroundlight" >Add Product</Link>
                </div>
                    ...
                    <tbody>
                        {
                            undergroundLight.map((product) => {
                                ...
                                return <tr key={product._id}>
                                    ...
                                    <td><Link to={`/admin/editundergroundlight/${product._id}`} className="bg-transparent" ><FaEdit className="bg-transparent" /></Link></td>
...
export default AdminUnderGroundLight;