...
const EditAdminUnderGroundLight = () => {
  ...
  const getSingleProduct = async (id) => {
    const response = await fetch(`${server}/api/v1/lightingfixture/adminarchitecture/getsingalundergroundlight/${id}`, {
      method: "GET",
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${server}/api/v1/lightingfixture/adminarchitecture/updateundergroundlight/${id}`, {
        method: "PUT",
        headers: {
          "Authorization": authorizationToken,
      ...
      if (response.ok) {
        ...
        setSpinner(false)
        navigate("/admin/undergroundlight")
  ...
  return (
    <>
      <div className="container my-5">
        <h2 className="fw-bold mb-3">Edit Under Ground Product</h2>
...
export default EditAdminUnderGroundLight;