...
const AddAdminDynamicFacade = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/lightingfixture/adminarchitecture/adddynamicfacade`, {
                method: "POST",
                headers: {
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Add Dynamic Facade Product</h2>
...
export default AddAdminDynamicFacade;