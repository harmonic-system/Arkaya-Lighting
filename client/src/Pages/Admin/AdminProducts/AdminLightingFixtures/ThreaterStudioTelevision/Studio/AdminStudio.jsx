    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Admin Studio Products</h2>
                <div className="w-100 d-flex justify-content-end my-5">
                    <Link className="btn btn-warning" to="/admin/addstudio" >Add Product</Link>
                </div>
                    ...
                    <tbody>
                        {
                            studio.map((product) => {
                                ...
                                return <tr key={product._id}>
                                    ...
                                    <td><Link to={`/admin/editstudio/${product._id}`} className="bg-transparent" ><FaEdit className="bg-transparent" /></Link></td>
