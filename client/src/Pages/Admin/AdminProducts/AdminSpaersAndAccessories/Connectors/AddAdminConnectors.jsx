...
const AddAdminConnectors = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/spaersaccessroies/adminconnectors/addconnector`, {
                method: "POST",
                headers: {
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Add Connectors Product</h2>
...
export default AddAdminConnectors;