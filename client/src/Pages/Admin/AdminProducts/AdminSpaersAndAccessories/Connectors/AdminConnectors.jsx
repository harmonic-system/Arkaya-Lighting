    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Admin Connectors Products</h2>
                <div className="w-100 d-flex justify-content-end my-5">
                    <Link className="btn btn-warning" to="/admin/addconnectors" >Add Product</Link>
                </div>
                    ...
                    <tbody>
                        {
                            connectors.map((product) => {
                                ...
                                return <tr key={product._id}>
                                    ...
                                    <td><Link to={`/admin/editconnectors/${product._id}`} className="bg-transparent" ><FaEdit className="bg-transparent" /></Link></td>
