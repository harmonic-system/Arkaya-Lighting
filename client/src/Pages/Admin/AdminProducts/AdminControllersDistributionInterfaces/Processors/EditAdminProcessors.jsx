...
const EditAdminProcessoers = () => {
    ...
    const getSingleProduct = async (id) => {
        const response = await fetch(`${server}/api/v1/controllerdistributioninterfaces/adminprocessors/getsingalprocessor/${id}`, {
            method: "GET",
            headers: {
                "Authorization": token
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/controllerdistributioninterfaces/adminprocessors/updateprocessor/${id}`, {
                method: "PUT",
                headers: {
                    "Authorization": token,
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Edit Processors Product</h2>
...
export default EditAdminProcessoers;