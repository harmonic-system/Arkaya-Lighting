...
const EditAdminDecorderAndAmplifiers = () => {
    ...
    const getSingleProduct = async (id) => {
        const response = await fetch(`${server}/api/v1/controllerdistributioninterfaces/admindecorderamplifiers/getsingaldecorderandamplifier/${id}`, {
            method: "GET",
            headers: {
                "Authorization": token
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/controllerdistributioninterfaces/admindecorderamplifiers/updatedecorderandamplifier/${id}`, {
                method: "PUT",
                headers: {
                    "Authorization": token,
            ...
            if (response.ok) {
                ...
                setSpinner(false)
                navigate("/admin/decorderandamplifier")
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Edit Decorder And Amplifiers Product</h2>
...
export default EditAdminDecorderAndAmplifiers;