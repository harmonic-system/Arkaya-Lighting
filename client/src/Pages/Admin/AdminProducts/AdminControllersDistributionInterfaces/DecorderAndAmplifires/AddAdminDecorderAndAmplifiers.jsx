...
const AddAdminDecorderAndAmplifiers = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/controllerdistributioninterfaces/admindecorderamplifiers/adddecorderandamplifier`, {
                method: "POST",
                headers: {
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Add Decorder And Amplifiers Product</h2>
...
export default AddAdminDecorderAndAmplifiers;