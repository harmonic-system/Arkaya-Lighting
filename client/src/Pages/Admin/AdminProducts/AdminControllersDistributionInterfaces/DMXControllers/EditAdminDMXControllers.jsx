...
const EditAdminDMXControllers = () => {
    ...
    const getSingleProduct = async (id) => {
        const response = await fetch(`${server}/api/v1/controllerdistributioninterfaces/admindmxcontrollers/getsingaldmxcontroller/${id}`, {
            method: "GET",
            headers: {
                "Authorization": token
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/controllerdistributioninterfaces/admindmxcontrollers/updatedmxcontroller/${id}`, {
                method: "PUT",
                headers: {
                    "Authorization": token,
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Edit DMX Controllers Product</h2>
...
export default EditAdminDMXControllers;