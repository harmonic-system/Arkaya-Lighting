...
const AddAdminLEDControllers = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/controllerdistributioninterfaces/adminledcontrollers/addledcontroller`, {
                method: "POST",
                headers: {
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Add LED Controllers Product</h2>
...
export default AddAdminLEDControllers;