...
const EditAdminStageLightingSystems = () => {
    ...
    const getSingleProduct = async (id) => {
        const response = await fetch(`${server}/api/v1/rigging/adminstagelightingsystem/getsingalstagelightingsystem/${id}`, {
            method: "GET",
            headers: {
                "Authorization": token
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/rigging/adminstagelightingsystem/updatestagelightingsystem/${id}`, {
                method: "PUT",
                headers: {
                    "Authorization": token,
            ...
            if (response.ok) {
                ...
                setSpinner(false)
                navigate("/admin/stagelightingsystem")
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Edit Stage Lighting Systems Product</h2>
...
export default EditAdminStageLightingSystems;