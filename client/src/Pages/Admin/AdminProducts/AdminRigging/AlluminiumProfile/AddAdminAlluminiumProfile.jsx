...
const AddAdminAlluminiumProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/rigging/adminalluminiumprofile/addalluminiumprofile`, {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
                ...
                setSpinner(false)
                navigate("/admin/alluminiumprofile")
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Add Alluminium Profile Product</h2>
...
export default AddAdminAlluminiumProfile;