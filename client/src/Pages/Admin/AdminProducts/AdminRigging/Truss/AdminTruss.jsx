    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Admin Truss Products</h2>
                <div className="w-100 d-flex justify-content-end my-5">
                    <Link className="btn btn-warning" to="/admin/addtruss" >Add Product</Link>
                </div>
                    ...
                    <tbody>
                        {
                            truss.map((product) => {
                                ...
                                return <tr key={product._id}>
                                    ...
                                    <td><Link to={`/admin/edittruss/${product._id}`} className="bg-transparent" ><FaEdit className="bg-transparent" /></Link></td>
