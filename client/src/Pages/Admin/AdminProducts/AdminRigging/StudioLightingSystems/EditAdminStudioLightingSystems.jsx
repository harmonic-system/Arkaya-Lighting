...
const EditAdminStudioLightingSystems = () => {
    ...
    const getSingleProduct = async (id) => {
        const response = await fetch(`${server}/api/v1/rigging/adminstudiolightingsystem/getsingalstudiolightingsystem/${id}`, {
            method: "GET",
            headers: {
                "Authorization": token
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/rigging/adminstudiolightingsystem/updatestudiolightingsystem/${id}`, {
                method: "PUT",
                headers: {
                    "Authorization": token,
            ...
            if (response.ok) {
                ...
                setSpinner(false)
                navigate("/admin/studiolightingsystem")
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Edit Studio Lighting Systems Product</h2>
...
export default EditAdminStudioLightingSystems;