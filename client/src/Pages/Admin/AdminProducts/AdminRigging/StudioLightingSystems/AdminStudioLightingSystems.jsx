    ...
    const deleteProduct = async (id) => {
        try {
            ...
            if (response.ok) {
                ...
                getAllStudioLightingSystemProducts()
            }
        } catch (error) {
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Admin Studio Lighting Systems Products</h2>
                <div className="w-100 d-flex justify-content-end my-5">
                    <Link className="btn btn-warning" to="/admin/addstudiolightingsystem" >Add Product</Link>
                </div>
                    ...
                    <tbody>
                        {
                            studioLightingSystem.map((product) => {
                                ...
                                return <tr key={product._id}>
                                    ...
                                    <td><Link to={`/admin/editstudiolightingsystem/${product._id}`} className="bg-transparent" ><FaEdit className="bg-transparent" /></Link></td>
...
export default AdminStudioLightingSystems;