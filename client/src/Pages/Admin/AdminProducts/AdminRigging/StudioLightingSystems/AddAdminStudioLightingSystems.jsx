...
const AddAdminStudioLightingSystems = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/rigging/adminstudiolightingsystem/addstudiolightingsystem`, {
                method: "POST",
                headers: {
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Add Studio Lighting Systems Product</h2>
...
export default AddAdminStudioLightingSystems;