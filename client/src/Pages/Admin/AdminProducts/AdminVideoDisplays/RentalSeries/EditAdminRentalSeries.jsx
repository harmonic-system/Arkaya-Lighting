...
const EditAdminRentalSeries = () => {
    ...
    const getSingleProduct = async (id) => {
        const response = await fetch(`${server}/api/v1/videodisplays/adminrentalseries/getsingalrentalseries/${id}`, {
            method: "GET",
            headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/videodisplays/adminrentalseries/updaterentalseries/${id}`, {
                method: "PUT",
                headers: {
                    "Authorization": authorizationToken,
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Edit Rental Series Product</h2>
...
export default EditAdminRentalSeries;