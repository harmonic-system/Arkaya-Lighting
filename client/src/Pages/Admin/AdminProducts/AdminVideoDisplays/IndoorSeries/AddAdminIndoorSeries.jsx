...
const AddAdminIndoorSeries = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${server}/api/v1/videodisplays/adminindoorseries/addindoorseries`, {
                method: "POST",
                headers: {
    ...
    return (
        <>
            <div className="container my-5">
                <h2 className="fw-bold mb-3">Add Indoor Product</h2>
...
export default AddAdminIndoorSeries;